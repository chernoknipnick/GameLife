...
export default function Abilities({ stats }) {
  return (
    <section className="abilities" aria-label="Характеристики">
      ...
      {/* FR-3.4b: дисциплина не только отделена цветом, но и названа
          пассивной. Объяснение было только в листе создания привычки, а
          вопрос «почему растёт то, чего я не выбирал» возникает здесь. */}
      <p className="abilities__note">Дисциплина растёт с любой привычки — её не выбирают</p>
    </section>
  );
}
